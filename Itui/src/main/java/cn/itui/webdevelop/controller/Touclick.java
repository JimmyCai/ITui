...
public class Touclick {
	...
	@Value("#{configProperties[recaptcha.site.key]}")
	private static String website_key;
	@Value("#{configProperties[recaptcha.site.secret]}")
	...
	public static Boolean check(String check_key, String check_address, String client_ip, String user_name, String user_id)
	{
	...
	public static String getWebsite_key() {
		return website_key;
	}
	public static void setWebsite_key(String website_key) {
		Touclick.website_key = website_key;
	}
	public static String getPrivate_key() {
		return private_key;
	}
	public static void setPrivate_key(String private_key) {
		Touclick.private_key = private_key;
	}
}

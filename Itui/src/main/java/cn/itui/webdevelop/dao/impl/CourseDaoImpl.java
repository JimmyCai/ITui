...
public class CourseDaoImpl implements CourseDao {
	...
	public List<HashMap<String, Object>> getAllAliveCourseInfo() {
		return sqlSession
				.selectList("cn.itui.webdevelop.dao.CourseDao.getAllAliveCourseInfo");
	}

	public int insertCourseInfo(HashMap<String, Object> courseInfos) {
		int courseId = -2;
		try {
			courseId = sqlSession.insert(
					"cn.itui.webdevelop.dao.CourseDao.insertCourseInfo",
					courseInfos);
	...
	public int verifyPermissionByCode(String code) {
		return sqlSession
				.selectOne(
						"cn.itui.webdevelop.dao.CourseDao.verifyPermissionByCode",
						code);
	}

	public int getLastId() {
		return sqlSession
				.selectOne("cn.itui.webdevelop.dao.CourseDao.getLastId");
	}
	...
	public int insertTeacherInfo(String teacherName, String photoName,
		...
		try {
			sqlSession.insert(
					"cn.itui.webdevelop.dao.CourseDao.insertTeacherInfo",
					teacher);
		} catch (DuplicateKeyException dke) {
			dke.printStackTrace();
			return -1;
	...
	public List<HashMap<String, Object>> getAllCourseInfo() {
		return sqlSession
				.selectList("cn.itui.webdevelop.dao.CourseDao.getAllCourseInfo");
	}

	public List<HashMap<String, Object>> getAllEndedCourseInfo() {
		return sqlSession
				.selectList("cn.itui.webdevelop.dao.CourseDao.getAllEndedCourseInfo");
	}

	public int removeCourse(String courseCode) {
		return sqlSession.delete(
				"cn.itui.webdevelop.dao.CourseDao.removeCourse", courseCode);
	}
